...
class DiffusionModule(pl.LightningModule):
    ...
    def __init__(
        ...
        use_ema: bool = False, #exponential moving average -> smooth out fluatuations in data
        compile: bool = False, #optimize model execution
    ) -> None:
        super().__init__()
        # this line allows to access init params with 'self.hparams' attribute
        # also ensures init params will be stored in ckpt (checkpoint ~ snapshot of model)
    ...
    def model_step(
        ...
        """
        batch, _ = batch # input image and label?
        preds, targets = self.forward(batch) # image and sample?
    ...
    def setup(self, stage: str) -> None:
        ...
        """
        if self.hparams.compile and stage == "fit": # fit ~ train model to fit to data
